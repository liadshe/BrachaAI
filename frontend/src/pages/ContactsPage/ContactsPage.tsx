        ...
        <div className={styles.pageWrapper}>
            <div className={styles.contentArea}>
                <header className={styles.header}>
                    ...
                    <p className={styles.pageIntroText}>Search, review, and manage all of your clients.</p>
                </header>
                            ...
                            {loading ? (
                                ...
                                <div className={styles.emptyState}>
                                    <div className={styles.emptyCard}>
                                        ...
                                        <p className={styles.emptySubText}>Add a contact to see them listed here.</p>
                                    </div>
                                </div>
                            )}
                        </div>
